                            ...
                            <div className='d-flex flex-row gap-2 p-2'>
                                ...
                                <div className='d-flex flex-column gap-2'>
                                    ...
                                    <div className='d-flex align-items-center grey gap-2 smallText'>
                                        <p>{data.days} Days ago</p>&bull;<img src="https://res.cloudinary.com/dibccigcp/image/upload/v1664264186/LinkedIn_Icon_naugpk.svg" style={{ maxWidth: "20px" }} /><p>Easy Apply</p>
                                    </div>
                                </div>
                            </div>
