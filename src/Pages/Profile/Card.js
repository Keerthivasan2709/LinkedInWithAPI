            ...
            <div>
                ...
                <div className='d-flex flex-row align-items-start gap-2'>
                    ...
                    <div className='d-flex flex-column gap-1'>
                        ...
                        <p style={{ fontSize: "15px" }} className='grey'>{organization}</p>
                        <p style={{ fontSize: "15px" }} className='grey'>{date}</p>
                        <p style={{ fontSize: "15px" }} className='grey'>{place}</p>
                        {showSkill ? <div style={{ fontSize: "15px" }}>
                            <span className='makeBold'>Skills: </span><span>Javascript</span>
                        </div> : <></>}
                    </div>
                </div>
            </div>
