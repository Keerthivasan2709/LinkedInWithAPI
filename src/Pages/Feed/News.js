                ...
                data.map(data => {
                    return (
                        <div className='list mb-1 d-flex gap-2'>
                            ...
                            <div>
                                <div className='newsHeading' style={{ width: "250px", overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>{data.title}</div>
                                <div className='d-flex gap-2 align-items-center'>
                                    <div className='newsDetails'>{findDays(data.createdAt)}days ago</div>
                                    &bull;
