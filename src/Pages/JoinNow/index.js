...
import { JoinLink } from '../../Assets/Url'
function Join() {
    ...
    const Render = () => {
        return (
            render === "0" ? (<Card firstLabel="Email or Phone Number" type="submit" name1="email" name2="password" secondLabel="Password(6 or more character)" showLink={true} format="Join" className="bg-white p-5" number="1" value="Join Now" handleForm={handleChange} handleSubmit={handleSubmit} />) :
                render == "1" ? <Card firstLabel="First Name" secondLabel="Second Name" showLink={false} format="yes" className="bg-white p-5 w-100" number="2" type="render" setRender={setRender} name1="firstName" name2="secondName" value="continue" handleForm={handleDetails} /> :
