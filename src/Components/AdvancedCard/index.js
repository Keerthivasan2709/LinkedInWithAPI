  ...
  return (
    <div className='list card'>
              ...
              <div className='d-flex mt-2 justify-content-between align-items-start'>
                <div className='mt-2 mb-2 d-flex flex-row align-items-start gap-2'>
                  ...
                  <div className='d-flex flex-column gap-1'>
                    ...
                    <p className='black' style={{ fontSize: "15px" }}>{data.roleDescription}</p>
                ...
                <img src="https://res.cloudinary.com/dibccigcp/image/upload/v1665036141/index_rlcvc7.svg" className='mt-2' />
              </div>
      ...
      <center className='mt-2 mb-2'>
        <Link to=""className='grey' >Show All</Link>
      </center>
    </div>
  )
}
