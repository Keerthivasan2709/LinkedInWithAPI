      ...
      <div id="myModal" class="modal" ref={modalDiv}>
        ...
        >
          ...
          >
            ...
            <Link to="/profile/editExperience">+ Add new Position</Link>
            <div>
              <input type="checkbox" id="current" />
              <label for="current">Show current company in my intro</label>
            </div>
            <div className="d-flex flex-column">
            ...
            <p>
              Learn more about <Link to="">industry option</Link>
            </p>
            ...
            <Link to="/profile/editEducation">+ Add new Education</Link>
            <div>
              <input type="checkbox" id="education" />
              <label for="education">Show Education in my intro</label>
            </div>
